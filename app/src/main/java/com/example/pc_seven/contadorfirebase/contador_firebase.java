package com.example.pc_seven.contadorfirebase;
...
public class contador_firebase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contador_firebase);

        // Write a message to the database
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference FNnumero = database.getReference();
        //FNnumero.setValue(7);
        // #se hizo para validar el dato en la nube

        FNnumero.child("contador_numerico").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                numero++;
                FNnumero.child("contador_numerico").setValue(numero);
            }
        });
